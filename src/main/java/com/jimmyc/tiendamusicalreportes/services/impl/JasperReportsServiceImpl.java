 ...
 * 
 */
package com.jimmyc.tiendamusicalreportes.services.impl;
...
import com.jimmyc.tiendamusicalreportes.services.JasperReportsService;
...
/**
 * @author JimmyC
 * Clase que implementa los metodos de logica de negocio de JasperReports
 */
...
public class JasperReportsServiceImpl implements JasperReportsService {
	...
	public JasperPrint compilarReporteJasper(ByteArrayOutputStream archivoBytes, String orderID) throws ClassNotFoundException, SQLException, JRException, IOException {
		...
		InputStream imageInputStream = this.getClass().getClassLoader().getResourceAsStream("images/jimmyc.png");
